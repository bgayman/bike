...
final class SlideUpTransition: NSObject
{
    ...
    let alphaFadeTo: CGFloat = 0.2
    
    init(duration: TimeInterval = 0.25,  isAppearing: Bool, view: UIView? = nil, presentedVC: UIViewController? = nil)
    {
    ...
    private func handlePan(_ sender: UIPanGestureRecognizer)
    {
        ...
        case .changed:
            ...
            toVC?.view.alpha = alphaFadeTo + (progress * 0.5)
...
extension SlideUpTransition: UIViewControllerAnimatedTransitioning
{
    func animateTransition(using transitionContext: UIViewControllerContextTransitioning)
    {
        ...
        if self.isAppearing
        {
            ...
            toViewInitialFrame.origin.y = containerView.frame.maxY
...
extension SlideUpTransition: UIViewControllerInteractiveTransitioning
{
